...
function App() {
  ...
  const load3d = async () => {
    let isloaded = await loader.loadAsync("./gltf/ventilator2.gltf");
    !isloaded ? setModelLoading(false) : setModelLoading(true);
    loader.load(
  ...
  return (
    <div className="App">
      {!modelLoading ? (
        ...
        <>
          <div className="text-slate-500  tracking-wider md:text-6xl text-4xl uppercase font-bold absolute top-3/4 text-center -translate-x-1/2 md:top-1/2  left-1/2">
            <h1 id="title " className="invert">
              {" "}
              ventilation device
            </h1>
